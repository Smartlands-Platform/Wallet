    ...
    d.AmCoordinateChart = d.Class({
        ...
        parseSerialData: function(a) {
            ...
            if (a)
                if (0 < this.processTimeout) {
                    ...
                    // console.log('parseCount', this.parseCount);
        ...
        parsePartSerialData: function(a, b, c, e) {
            ...
            for (u = b; u < c; u++) {
                ...
                this.chartData[u] = B;
                // console.log('!!!!!!!!!!!!!!!!!!!!!11>>> this.chartData[u]', this.chartData[u])
            }
